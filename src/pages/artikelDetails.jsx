  ...
  return (
    <div className="p-5">
      ...
      <div className="px-20 pb-10">
          <h1 className="my-5 pl-2 text-3xl font-bold text-tertiary">
              Komentar
          </h1>
      ...
      <div className="px-20">
        <div className="grid grid-cols-1">
            <div className="w-full border-2 rounded bg-slate-100 p-6">
                ...
                <p className="mt-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, ipsum?</p>
            </div>
        </div>
      </div>
    </div>
