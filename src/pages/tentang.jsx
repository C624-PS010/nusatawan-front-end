      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:pt-20 px-20 lg:px-48 pb-10">
          ...
          <div>
            ...
            <p className="text-justify">
              Mahasiswa S1 Teknik Informatika Universitas Pasundan yang saat ini sedang menjalani
              program MSIB di Dicoding dengan learning path Front-End Web dan Back-End. Saya
              memiliki ketertarikan pada bidang Web Development dan UI/UX Design. Saya juga mahir
              dalam menggunakan HTML, CSS, PHP, JavaScript, dan framework seperti Laravel,
              Bootstrap, dan TailwindCSS untuk membangun aplikasi web.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:pt-20 px-20 lg:px-48 pb-10">
          ...
          <div>
            ...
            <p className="text-justify lg:pr-4">
              Saya adalah seorang mahasiswa Teknik Informatika di Universitas Pamulang, saat ini
              sedang mengikuti program SIB Batch 6 di Dicoding. Dengan minat yang kuat pada
              teknologi dan pemrograman, saya bercita-cita untuk menjadi Junior Web Developer.
            </p>
            <div className="flex justify-start gap-5 lg:gap-10 md:w-[75%] my-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:pt-20 px-20 lg:px-48 pb-10">
          ...
          <div>
            ...
            <p className="text-justify">
              Saya adalah seseorang yang sangat tertarik dengan dunia teknologi yang terus
              berkembang. Saat ini, saya fokus untuk mengasah kemampuan saya dalam pengembangan web
              dan aplikasi, terutama dalam PHP dan JavaScript. Saya memiliki minat yang kuat untuk
              menemukan tren dan inovasi terbaru dalam industri teknologi, dan selalu bersemangat
              untuk memperluas pengetahuan dan keahlian saya.
            </p>
            <div className="flex justify-start gap-5 lg:gap-10 md:w-[75%] my-6">
