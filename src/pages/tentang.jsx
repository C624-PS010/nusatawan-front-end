...
const TentangPage = () => {
    return (
        <section>
            <div>
                <img src="./public/img/group.jpg" alt="" />
            </div>
            <div className="flex justify-center items-center text-center">
                <div className="lg:py-10">
                    ...
                    Di Nusatawan, Kami bertujuan untuk mempermudah proses pencarian destinasi ekowisata dan destinasi alternatif yang belum populer. 
                    <span className="block">
                        Dan tahukah Anda? Kami percaya bahwa platform yang ingin kami kembangkan ini tidak hanya akan memberikan manfaat</span> <span className="block"> kepada pengguna dalam menemukan destinasi wisata yang sesuai, tetapi juga akan berkontribusi pada keberlanjutan</span> <span className="block">  lingkungan dari segi ekonomi maupun dari segi lingkungan tempat wisata itu sendiri.</span>
                    </p>
                </div>
            </div>
            <div>
                <div className="justify-center items-center text-center pt-20">
                    ...
                    <div className="pt-5">
                        <p className="text-sm p-2 lg:font-medium lg:text-base">kami adalah sekelompok individu yang bersemangat bekerja sama untuk mencapai tujuan kami.
                            <span className="block">Dibalik kesuksesan platform ini, Kenali wajah-wajah Kami!</span>
                        </p>
                    </div>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-2 lg:pt-20 px-20 lg:px-48 pb-10">    
                    <div>
                        <img src="./public/img/aufaa1.jpg" 
                            alt="Gambar Team"
                    ...
                    <div>
                        ...
                        <p className="text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi ullam ad beatae non perspiciatis hic quam accusamus id blanditiis quo!</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 lg:pt-20 px-20 lg:px-48 pb-10">      
                    <div>
                        ...
                        <p className="text-justify lg:pr-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi ullam ad beatae non perspiciatis hic quam accusamus id blanditiis quo!</p>
                        <div className="flex justify-start gap-5 lg:gap-10 md:w-[75%] my-6">
                    ...
                    <div>
                        <img src="./public/img/adriansyah1.jpg" 
                            alt="Gambar Team"
                            className="lg:w-auto lg:h-[400px]"
                        />
                    </div>
